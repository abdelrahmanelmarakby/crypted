...
Future<void> _initializeZegoCallService() async {
  try {
    ...
    LoggerService.instance
        .info('ZEGO Call Service SDK initialized', context: 'main');
    ...
    if (UserService.currentUser.value != null) {
      ...
      try {
        ...
        LoggerService.instance
            .warning('Error getting FirebaseAuth user: $e', context: 'ZEGO');
      }
    }
    ...
    if (userID != null && userName != null) {
      ...
      LoggerService.instance
          .info('ZEGO user logged in: $userID', context: 'main');
    } else {
...
Future<void> _initializeRevenueCat() async {
  try {
    ...
    LoggerService.instance
        .info('RevenueCat initialized successfully', context: 'main');
  } catch (e) {
    LoggerService.instance.logError(
...
Future<void> main() async {
  ...
  try {
    ...
    LoggerService.instance
        .info('Firebase initialized successfully', context: 'main');
    ...
    LoggerService.instance
        .info('Realtime Database persistence enabled', context: 'main');
    ...
    LoggerService.instance
        .info('Awesome Notifications initialized', context: 'main');
    ...
    LoggerService.instance
        .info('AwesomeNotifications FCM initialized', context: 'main');
    ...
    LoggerService.instance
        .info('Notification listeners configured', context: 'main');

    // Initialize isolate communication
    await NotificationController.initializeIsolateReceivePort();
    LoggerService.instance
        .info('Isolate communication initialized', context: 'main');
    ...
    LoggerService.instance
        .info('All services initialized successfully', context: 'main');
  } catch (e, stackTrace) {
  ...
  try {
    ...
    LoggerService.instance
        .logError('App initialization failed', error: e, context: 'main');
  }
  ...
  Future<void> _requestTrackingPermission() async {
    if (Platform.isIOS) {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) async {
        ...
        LoggerService.instance
            .info('ATT permission status: $status', context: 'ATT');
      });
    }
  }
